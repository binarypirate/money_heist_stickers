...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    ////   Todo: interstital ads and banner ads



    private final String TAG = StickerPackListActivity.class.getSimpleName();
...
// Todo set banner and interstitial ads in this activity
    private void showStickerPackList(List<StickerPack> stickerPackList) {
//        TODO: setting interstitial ads firts
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.share)
            try {
                ...
                String sAux = "\n Tittle \n\n";
                sAux = sAux + "https://play.google.com/store/apps/details?id=com.stick.psychoapp";
